...
function createUsers()
{
    ...
    picture varchar(100) COLLATE utf8_bin NOT NULL DEFAULT 'pic/default.jpg', visited datetime(2) DEFAULT NULL, token varchar(150) COLLATE utf8_bin NOT NULL DEFAULT 'null',
